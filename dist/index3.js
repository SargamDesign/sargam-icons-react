...
const SvgSiAddToLibrary = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    fillRule: "evenodd",
    d: "M8.4 2h11.2A2.4 2.4 0 0 1 22 4.4v11.2a2.4 2.4 0 0 1-2.4 2.4H8.4A2.4 2.4 0 0 1 6 15.6V4.4A2.4 2.4 0 0 1 8.4 2ZM14 5a1 1 0 0 1 1 1v3h3a1 1 0 1 1 0 2h-3v3a1 1 0 1 1-2 0v-3h-3a1 1 0 1 1 0-2h3V6a1 1 0 0 1 1-1Z",
    clipRule: "evenodd"
  }), /*#__PURE__*/React__namespace.createElement("path", {
    fill: "currentColor",
    d: "M4 4a1 1 0 0 0-2 0v11.6C2 19.132 4.868 22 8.4 22H20a1 1 0 1 0 0-2H8.4A4.403 4.403 0 0 1 4 15.6V4Z"
  }));
};
...
const SvgSiCancelPhoto = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    fillRule: "evenodd",
    d: "M8.4 2h11.2A2.4 2.4 0 0 1 22 4.4v11.2a2.4 2.4 0 0 1-2.4 2.4H8.4A2.4 2.4 0 0 1 6 15.6V4.4A2.4 2.4 0 0 1 8.4 2Zm3.479 4.464a1 1 0 1 0-1.415 1.415L12.586 10l-2.122 2.121a1 1 0 0 0 1.415 1.415L14 11.414l2.121 2.122a1 1 0 1 0 1.415-1.415L15.414 10l2.122-2.121a1 1 0 0 0-1.415-1.415l-2.12 2.122-2.122-2.122Z",
    clipRule: "evenodd"
  }), /*#__PURE__*/React__namespace.createElement("path", {
    fill: "currentColor",
    d: "M4 4a1 1 0 0 0-2 0v11.6C2 19.132 4.868 22 8.4 22H20a1 1 0 1 0 0-2H8.4A4.403 4.403 0 0 1 4 15.6V4Z"
...
const SvgSiCheck = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    fillRule: "evenodd",
    d: "M19.633 6.226a1 1 0 0 1 .141 1.407l-9 11a1 1 0 0 1-1.481.074l-5-5a1 1 0 1 1 1.414-1.414l4.219 4.219 8.3-10.145a1 1 0 0 1 1.407-.141Z",
    clipRule: "evenodd"
  }));
};
...
const SvgSiClose = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    d: "M16.95 8.464a1 1 0 1 0-1.414-1.414L12 10.586 8.464 7.05A1 1 0 1 0 7.05 8.464L10.586 12 7.05 15.536a1 1 0 1 0 1.414 1.414L12 13.414l3.536 3.536a1 1 0 1 0 1.414-1.414L13.414 12l3.536-3.536Z"
  }));
};
...
const SvgSiEditSimple = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    d: "M16.738 3.727a1.3 1.3 0 0 1 1.838 0l1.697 1.697a1.3 1.3 0 0 1 0 1.838L8.818 18.718a.5.5 0 0 1-.255.136l-3.536.707a.5.5 0 0 1-.588-.588l.707-3.535a.5.5 0 0 1 .137-.256L16.738 3.727Z"
  }));
};
...
const SvgSiFilterNone = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    d: "M8.4 2h11.2A2.4 2.4 0 0 1 22 4.4v11.2a2.4 2.4 0 0 1-2.4 2.4H8.4A2.4 2.4 0 0 1 6 15.6V4.4A2.4 2.4 0 0 1 8.4 2Z"
  }), /*#__PURE__*/React__namespace.createElement("path", {
    fill: "currentColor",
    d: "M4 4a1 1 0 0 0-2 0v11.6C2 19.132 4.868 22 8.4 22H20a1 1 0 1 0 0-2H8.4A4.403 4.403 0 0 1 4 15.6V4Z"
  }));
...
const SvgSiInfo = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    fillRule: "evenodd",
    d: "M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10ZM11 8a1 1 0 0 0 1 1h.008a1 1 0 1 0 0-2H12a1 1 0 0 0-1 1Zm1 9a1 1 0 0 0 1-1v-5a1 1 0 1 0-2 0v5a1 1 0 0 0 1 1Z",
    clipRule: "evenodd"
  }));
};
...
const SvgSiLibraryBooks = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    fillRule: "evenodd",
    d: "M19.6 2H8.4A2.4 2.4 0 0 0 6 4.4v11.2A2.4 2.4 0 0 0 8.4 18h11.2a2.4 2.4 0 0 0 2.4-2.4V4.4A2.4 2.4 0 0 0 19.6 2ZM9 7a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1Zm1 2a1 1 0 0 0 0 2h8a1 1 0 1 0 0-2h-8Zm-1 4a1 1 0 0 1 1-1h4a1 1 0 1 1 0 2h-4a1 1 0 0 1-1-1Z",
    clipRule: "evenodd"
  }), /*#__PURE__*/React__namespace.createElement("path", {
    fill: "currentColor",
    d: "M4 4a1 1 0 0 0-2 0v11.6C2 19.132 4.868 22 8.4 22H20a1 1 0 1 0 0-2H8.4A4.403 4.403 0 0 1 4 15.6V4Z"
...
const SvgSiNotificationsAlt = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    fillRule: "evenodd",
    d: "M5 18a1 1 0 0 1-.894-1.447L6 12.764V10c0-3.728 2.55-6.86 6-7.748 3.45.888 6 4.02 6 7.748v2.764l1.894 3.789A1 1 0 0 1 19 18H5Zm3.126 1a4.002 4.002 0 0 0 7.748 0H8.126Z",
    clipRule: "evenodd"
  }));
};
...
const SvgSiStarAlt = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    d: "M12.025 2c-.455 0-.805.22-1.014.399-.22.189-.395.424-.512.659a1 1 0 0 0-.05.119L8.662 8.313H2.681c-.455 0-.805.22-1.014.399a2.14 2.14 0 0 0-.512.66c-.208.416-.18.858-.07 1.189.1.297.306.627.65.842l4.614 3.714-1.46 5.615c-.148.38-.115.769-.016 1.067.11.33.353.7.77.91a1.804 1.804 0 0 0 1.652 0 1.01 1.01 0 0 0 .134-.081l4.715-3.368 4.548 3.328c.404.355.847.353.999.352h.032c.146.001.561.003.952-.313.331-.215.53-.537.628-.828a1.58 1.58 0 0 0-.026-1.093l-1.68-5.484 4.78-3.869a1 1 0 0 0 .265-.33l.022-.043c.109-.215.336-.663.336-1.161a1 1 0 0 0-.106-.448 2.14 2.14 0 0 0-.511-.659c-.21-.18-.56-.399-1.014-.399h-5.87l-1.905-5.155a.994.994 0 0 0-.043-.1 2.14 2.14 0 0 0-.512-.66c-.21-.179-.56-.398-1.014-.398Z"
  }));
};
...
const SvgSiUser = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    d: "M6.25 7a5.75 5.75 0 1 1 11.5 0 5.75 5.75 0 0 1-11.5 0Zm5.547 7.261a.755.755 0 0 1 .13-.011h.145c.043 0 .088.004.13.011l7.295 1.283a.621.621 0 0 1 .038.008c1.343.31 2.787 1.163 3.069 2.82l.004.029.114.877v.002c.264 2.009-1.33 3.47-3.21 3.47a.753.753 0 0 1-.124-.01h-14.9c-1.881 0-3.475-1.462-3.21-3.472l.114-.869a.735.735 0 0 1 .005-.03c.28-1.627 1.735-2.528 3.077-2.819a.726.726 0 0 1 .029-.006l7.294-1.283Z"
  }));
};
...
const SvgSiUserAlt5 = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    fill: "currentColor",
    d: "M18.944 12.937a1 1 0 0 0-.668 1.886c.825.292 1.458.602 1.91.912.458.315.67.589.754.786a.96.96 0 0 0 .039.082l.001.147v3.65c0 .328-.272.6-.6.6H3.6a.605.605 0 0 1-.6-.6v-3.65l.001-.132v-.014a1.022 1.022 0 0 0 .036-.077c.09-.207.304-.479.759-.79.452-.31 1.084-.618 1.913-.916a1 1 0 1 0-.678-1.882c-.92.332-1.723.708-2.364 1.147-.63.43-1.16.96-1.454 1.622-.09.183-.153.366-.185.57a2.795 2.795 0 0 0-.028.45V20.4C1 21.832 2.168 23 3.6 23h16.833a2.605 2.605 0 0 0 2.547-2.6v-3.668c0-.108 0-.293-.024-.472a1.527 1.527 0 0 0-.232-.646c-.297-.615-.808-1.117-1.405-1.527-.643-.442-1.45-.822-2.375-1.15Z"
  }));
};
