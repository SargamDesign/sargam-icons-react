...
const SvgSiShieldBad = _ref => {
  ...
  return /*#__PURE__*/React__namespace.createElement("svg", _extends({
    ...
    strokeMiterlimit: 10,
    strokeWidth: 1.5,
    d: "m9.172 13.828 5.656-5.656m0 5.656L9.172 8.172M4 11.252c0 7.687 6.918 10.387 7.887 10.728.076.026.15.027.226 0C13.084 21.65 20 19.018 20 11.253V4.304a.4.4 0 0 0-.303-.389l-7.6-1.903a.4.4 0 0 0-.194 0l-7.6 1.903A.4.4 0 0 0 4 4.304z"
  }));
};
